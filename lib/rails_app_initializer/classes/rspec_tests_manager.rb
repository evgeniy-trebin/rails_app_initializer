module RAI
  class RspecTestsManager
    ...
    def configure
      ...
      create_directory('spec/support')
      create_support_helpers
      create_controller_macros
    ...
    def create_spec_helper
      update_file_with_content('spec/spec_helper.rb', content_for_spec_helper)
    end

    def create_rails_helper
      update_file_with_content('spec/rails_helper.rb', content_for_rails_helper)
    end

    def create_shared_contexts
      update_file_with_content('spec/shared_contexts.rb', content_for_shared_contexts)
    end

    def create_support_helpers
      update_file_with_content('spec/support/helpers.rb', content_for_support_helpers)
    end

    def create_support_devise
      update_file_with_content('spec/support/devise_request_spec_helpers.rb', content_for_support_devise)
    end

    def create_controller_macros
      update_file_with_content('spec/support/controller_macros.rb', content_for_controller_macros)
    end

    def content_for_spec_helper
      <<-CONTENT
...
RSpec.configure do |config|
  ...
  config.after(:all) do
    ...
    def content_for_shared_contexts
      <<-CONTENT
...
RSpec.shared_context 'for authorized user' do
  ...
  describe 'DELETE #destroy' do
    ...
    def content_for_support_helpers
      <<-CONTENT
module Helpers
  ...
  def for_authorized_expectation(status=200)
    ...
    def content_for_support_devise
      <<-CONTENT
module DeviseRequestSpecHelpers
  ...
  def sign_out(resource_or_scope)
    ...
    def content_for_controller_macros
      <<-CONTENT
